...
ByteBuffer::ByteBuffer(const char* data, uint64_t size):_size(size)
{
    _data = new char[size];
...
ViewByteBuffer::ViewByteBuffer(const char* data, uint64_t size):_size(size),_data(const_cast<char*>(data)){}
